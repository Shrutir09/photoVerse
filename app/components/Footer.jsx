          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-6">
            ...
            <div className="space-y-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 glass rounded-lg hover:bg-green-500/20 dark:bg-chalkboard-surface/30 dark:hover:bg-chalkboard-surface/40 dark:border dark:border-chalk-border/20 transition-all group mt-2 cursor-pointer hover:scale-105 active:scale-95"
                aria-label="Visit Photoverse GitHub repository"
              >
                <svg className="w-4 h-4 text-white dark:text-chalk-secondary group-hover:text-green-300 dark:group-hover:text-chalk-emerald transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <span className="text-xs font-medium text-white dark:text-chalk-secondary group-hover:text-green-300 dark:group-hover:text-chalk-emerald transition-colors">GitHub</span>
              </a>
            </div>
